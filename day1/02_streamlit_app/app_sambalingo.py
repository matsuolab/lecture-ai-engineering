...
from config_SambaLingo import MODEL_NAME
from huggingface_hub import HfFolder

# --- アプリケーション設定 ---
st.set_page_config(page_title="SambaLingo Chatbot", layout="wide")
...
# --- Streamlit アプリケーション ---
st.title("🤖 SambaLingo Chatbot with Feedback")
st.write("SambaLingoモデルを使用したチャットボットです。回答に対してフィードバックを行えます。")
st.markdown("---")
